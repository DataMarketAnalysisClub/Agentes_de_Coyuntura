"""Morning brief job: collects data, builds styled HTML email, sends it."""
...
def _generate_nix_analysis(
    ...
    Returns (html, chart_pngs) where:
    - html is empty if AI is disabled, fails, or times out. The caller is
      expected to show a 'no analysis available' hint in that case.
